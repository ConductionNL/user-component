...
class ZuiddrechtFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $userCheckin->setPerson($this->commonGroundService->cleanUrl(['component'=>'cc', 'type'=>'person', 'id'=>'25006d28-350a-42e9-b9ed-7afb25d4321d']));
        $userCheckin->setPassword($this->encoder->encodePassword($userBeheer, 'test1234'));
        $manager->persist($userBeheer);
