...
```CLI
$ helm del uc-dev  --purge --kubeconfig="api/helm/kubeconfig.yaml --namespace=dev" 
$ helm del uc-stag --purge --kubeconfig="api/helm/kubeconfig.yaml --namespace=stag" 
$ helm del uc-prod --purge --kubeconfig="api/helm/kubeconfig.yaml --namespace=prod" 
```
